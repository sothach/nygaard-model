...
{	
	...
	public IBAN ( String value)
	{
		if ( value == null)
		{
			throw new IllegalArgumentException ( "IBAN string cannot be null");
		}
		value = sanitize ( value); // strip any insignificant punctuation before processing
		if ( value.length () < 5)
		{
			throw new IllegalArgumentException ( "IBAN string must be at least 5 characters long");
		}
	...
	/**
	 * Parse the supplied string, returning an IBAN 
	 * @param value of the IBAN, may contain punctuation
	...
	/** {@inheritDoc} */
	@Override
	public String externalForm () { return value; }
	
	/** @return the BankCode segment of this IBAN */
	public String getBankCode() { return scheme.getBankCode(value); }
	/** @return the BranchCode segment of this IBAN */
	public String getBranchCode() { return scheme.getBranchCode(value); }
	/** @return the AccountNumber segment of this IBAN */
	public String getAccountNumber() { return scheme.getAccountNumber(value); }
